...
bool xyVision::GetTarget::binarizeTarget(const Mat & img, Mat & bi, vector<Point> & tarContour)
{
	...
	// filter areas that are not rectangle
	...
	//	double boxArea = box.size.area()+0.01;
	//	if ((area / boxArea) > 0.5)
	//	{
