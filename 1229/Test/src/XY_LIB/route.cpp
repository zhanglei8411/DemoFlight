...
int temporary_init_route_list(void)
{
	...
	XY_Debug_Get_Pos(&debug_package.start, task_info.start._longti, task_info.start._lati, task_info.start._alti, 0);
	XY_Debug_Get_Pos(&debug_package.end, task_info.end._longti, task_info.end._lati, task_info.end._alti, 0);
